...
<html>
  ...
  <body role="document" id="bootstrap-override" style="background-image: url('imgs/fancy-pants.jpg');">
	...
	<div id="main-container" role="main" style="background-color: #222233;">
		...
		<div id="guidance-div" class="row">

	  		<br><br>

			<div id="subheading" class="text-center">
				<span style="font-size:42px; font-family: horror, Arial, Helvetica, sans-serif; color:#eedddd;">Thanatophobia</span>
		...
		<div style="padding-left:25px; padding-right:25px; display: flex; align-items: center; justify-content: center;">
			<form id="frmChat" action="#">
			
			<div style="display:flex; align-items:right; justify-content:right; margin-bottom:10px;" class="tohide">
	  			<div>
					<span style="color:white; fontsize:16px;">What is your name?</span> &nbsp;

					<span style="color:black;">
						<input type="text" id="txtUser" name="user" size="10" value="" autofocus />
					</span>
					...
					<span style="color:black; ">
						<input type="submit" name="send" value="BEGIN" onclick="hideAndShow();" />
					</span>
			...
			<div class="toshow" style="display:None;">
				<div style="display:flex; align-items:center; justify-content:center;">
					...
					<span>
						<input type="text" name="message" id="txtMessage" size="40" style="margin-bottom:10px;" />
	...
	<div class="text-center">
		<a onclick="hideOrShow();" style="cursor:pointer; color:#ccccee; font-size:18px;">HELP</a>
	</div>
	...
	<div id="howsmart" style="display:None; font-size:12px; margin:15px 30px; align-items:center; justify-content:center;">
			<div style="max-width:650px; color:white;">
				...
				She can answer basic questions about the world (e.g. "Is a snake a mammal?", "Can you eat a boulder?", "Is Brad Pitt an actor?") albeit sometimes imperfectly.
	...
	<div style="fontsize:12px; color:#dddddd; margin-bottom:8px;" class="text-center">
		...
		<br>Photo by Kenny Eliason. Art by <a href="https://www.midjourney.com/home/">Midjourney</a>. Tested by __. Copyright 2022.
	</div>
