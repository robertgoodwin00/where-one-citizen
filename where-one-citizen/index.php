  ...
  <body role="document" id="bootstrap-override" style="background-image: url('imgs/fancy-pants.jpg');">
	...
	<div id="main-container" role="main" style="background-color:#222233;">
		...
		<div id="theform">
			...
			<div class="tohide" style="display:flex; align-items:right; justify-content:right; margin-top:14px; margin-bottom:10px;" >
	  			<div>
					<span id="whatisyourname">What is your name?</span> &nbsp;
					
					<div id="spacing"></div>

					<!--<label for="txtUser" id="whatisyourname">What is your name</label> &nbsp;-->
	...
	var currentImg = 1;
	var newImg = 1;
	var flash = false; // flash the green checkmarks
						...
						switch (command) {
							...
							case 'cm': // checkmark
								...
								if (interval==1) { // has seen figure's blue lips
									if (document.getElementById("checkmark1").style.display != "inline") 
										flash = true;
									document.getElementById("checkmark1").style.display = "inline";
								}
								else if (interval==2) { // knows about kim's blue lips
									if (document.getElementById("checkmark2").style.display != "inline") 
										flash = true;
									...
									if (document.getElementById("checkmark3").style.display != "inline") 
										flash = true;
								...
								if (flash) {
									flash = false;
									$("#checkmarks").fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100).fadeOut(100).fadeIn(100);
								}
								break;
							case 'sys':
								if (interval==1)
	...
	<div style="color:green; font-weight:bold; font-size:20px; margin:5px 25px;" class="text-center" id="checkmarks">
	...
	<div id="about" style="display:None; margin:15px 30px; align-items:center; justify-content:center;">
		<div style="max-width:650px; color:white;">
			...
			<div id="hints" style="display:None; margin:15px 30px; align-items:center; justify-content:center;">
                ...
                <div class="answer">
                    Once you have found the two Details, Madeline will, eventually, ask you about how they are connected.
	...
	<div style="fontsize:10px; color:#aaaaaa; margin-bottom:8px; padding-left:10px; padding-right:10px;" class="text-center">
		(if Madeline does not respond, the server may be down. Please try again later.)
	</div>

	<br><br><br><br>

	<div style="fontsize:12px; color:#dddddd; margin-bottom:8px; padding-left:10px; padding-right:10px;" class="text-center">
		...
		<br>Photo by Kenny Eliason. Art by <a href="https://www.midjourney.com/home/">Midjourney</a>. Tested by Mike Russo, Andrew Schultz. Copyright 2022.
	</div>
	...
	<div id="howsmart" style="display:None; font-size:12px; margin:15px 30px; align-items:center; justify-content:center;">
			<div style="max-width:650px; color:white;">
				...
				She can perform basic arithmetic and has an extensive dictionary and knowledge about the world.
